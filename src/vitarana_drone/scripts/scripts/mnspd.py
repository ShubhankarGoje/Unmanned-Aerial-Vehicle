...
class path_finder():
    ...
    def __init__(self):
        ...
        rospy.Subscriber('/package_picked', Bool ,  self.package_picked_callback)
    ...
    #Checks if Package is picked
    def package_picked_callback(self, msg):
        self.package_picked = msg.data
    ...
    def planning(self):
        ...
        if(self.package_picked and abs(self.drone_orientation_euler[1])<0.1 and abs(self.drone_orientation_euler[0])<0.1 and self.target_distance > self.tolerance[1] and not self.mnspd_active and self.is_yaw_set(yaw=self.target_yaw)):
