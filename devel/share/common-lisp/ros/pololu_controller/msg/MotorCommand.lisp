...
(cl:in-package pololu_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <MotorCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pololu_controller-msg:<MotorCommand> is deprecated: use pololu_controller-msg:MotorCommand instead.")))

(cl:ensure-generic-function 'joint_name-val :lambda-list '(m))
(cl:defmethod joint_name-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pololu_controller-msg:joint_name-val is deprecated.  Use pololu_controller-msg:joint_name instead.")
  (joint_name m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pololu_controller-msg:position-val is deprecated.  Use pololu_controller-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pololu_controller-msg:speed-val is deprecated.  Use pololu_controller-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <MotorCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pololu_controller-msg:acceleration-val is deprecated.  Use pololu_controller-msg:acceleration instead.")
  (acceleration m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorCommand>)))
  ...
  "pololu_controller/MotorCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorCommand)))
  "Returns string type for a message object of type 'MotorCommand"
  "pololu_controller/MotorCommand")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorCommand>)))
  ...
  (cl:format cl:nil "string joint_name       # Name of the joint (specified in the yaml file), or motor_id for default calibration~%float64 position        # Position to move to in PWN~%float32 speed           # Speed to move at (0.0 - 1.0)~%float32 acceleration    # Acceleration to move at (0.0 - 1.0)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorCommand)))
  "Returns full string definition for message of type 'MotorCommand"
  (cl:format cl:nil "string joint_name       # Name of the joint (specified in the yaml file), or motor_id for default calibration~%float64 position        # Position to move to in PWN~%float32 speed           # Speed to move at (0.0 - 1.0)~%float32 acceleration    # Acceleration to move at (0.0 - 1.0)~%~%~%"))
