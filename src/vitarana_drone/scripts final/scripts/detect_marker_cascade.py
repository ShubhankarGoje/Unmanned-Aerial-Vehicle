...
import math
# import os
# os.chdir("/home/shubhankargoje/catkin_ws/src/vitarana_drone/scripts/Neg_img")
...
class image_proc():
	...
	def __init__(self):
		...
		self.y_dis = 0.0
		# self.i=0                                                                               # Stores the y_err for calculation purpose
	...
	def image_callback(self, data):
		...
		# self.i+=1
		# cv2.imwrite(str(self.i)+".jpeg",self.gray)
