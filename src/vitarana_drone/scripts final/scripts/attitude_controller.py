...
class Edrone():
    ...
    def pid(self):
        ...
        self.pwm_cmd.prop1 = self.throttle_e+(output[0]/4)-(output[1]/4)+(output[2]/1.2)
        self.pwm_cmd.prop2 = self.throttle_e+(output[0]/4)+(output[1]/4)-(output[2]/1.2)
        self.pwm_cmd.prop3 = self.throttle_e-(output[0]/4)+(output[1]/4)+(output[2]/1.2)
        self.pwm_cmd.prop4 = self.throttle_e-(output[0]/4)-(output[1]/4)-(output[2]/1.2)
