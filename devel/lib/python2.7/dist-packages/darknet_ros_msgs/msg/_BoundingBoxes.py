...
class BoundingBoxes(genpy.Message):
  _md5sum = "73082496dd4b884fcf28c2780a201ac5"
...
"""
  __slots__ = ['header','image_header','bounding_boxes','image']
  _slot_types = ['std_msgs/Header','std_msgs/Header','darknet_ros_msgs/BoundingBox[]','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,image_header,bounding_boxes,image
