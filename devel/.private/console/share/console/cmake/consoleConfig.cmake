...
if("TRUE" STREQUAL "TRUE")
  set(console_SOURCE_PREFIX /home/shubhankargoje/catkin_ws/src/cusub-develop/cusub_common/debugging_tools/console)
  set(console_DEVEL_PREFIX /home/shubhankargoje/catkin_ws/devel/.private/console)
  set(console_INSTALL_PREFIX "")
  set(console_PREFIX ${console_DEVEL_PREFIX})
else()
  set(console_SOURCE_PREFIX "")
  set(console_DEVEL_PREFIX "")
  set(console_INSTALL_PREFIX /home/shubhankargoje/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'console' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'console' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shubhankargoje/catkin_ws/src/cusub-develop/cusub_common/debugging_tools/console/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT console_NUM_DUMMY_TARGETS)
      set(console_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::console::wrapped-linker-option${console_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR console_NUM_DUMMY_TARGETS "${console_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::console::wrapped-linker-option${console_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND console_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shubhankargoje/catkin_ws/devel/.private/console/lib;/home/shubhankargoje/catkin_ws/devel/lib;/opt/ros/melodic/lib)
