...
class CheckForObjectsAction(genpy.Message):
  _md5sum = "2494c4a4da5e32ca67f41117e47570c5"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.action_result.result.bounding_boxes.image.header.seq, _x.action_result.result.bounding_boxes.image.header.stamp.secs, _x.action_result.result.bounding_boxes.image.header.stamp.nsecs))
      _x = self.action_result.result.bounding_boxes.image.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.action_result.result.bounding_boxes.image.height, _x.action_result.result.bounding_boxes.image.width))
      _x = self.action_result.result.bounding_boxes.image.encoding
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_BI().pack(_x.action_result.result.bounding_boxes.image.is_bigendian, _x.action_result.result.bounding_boxes.image.step))
      _x = self.action_result.result.bounding_boxes.image.data
      length = len(_x)
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(struct.Struct('<I%sB'%length).pack(length, *_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.bounding_boxes.image.header.seq, _x.action_result.result.bounding_boxes.image.header.stamp.secs, _x.action_result.result.bounding_boxes.image.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.bounding_boxes.image.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.bounding_boxes.image.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.action_result.result.bounding_boxes.image.height, _x.action_result.result.bounding_boxes.image.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.bounding_boxes.image.encoding = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.bounding_boxes.image.encoding = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.action_result.result.bounding_boxes.image.is_bigendian, _x.action_result.result.bounding_boxes.image.step,) = _get_struct_BI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.action_result.result.bounding_boxes.image.data = str[start:end]
      _x = self
      start = end
      end += 12
